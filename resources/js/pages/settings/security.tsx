                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Un code sécurisé et aléatoire vous sera demandé lors
                                de la connexion ; vous pouvez l'obtenir depuis
                                l'application TOTP compatible installée sur votre
                                téléphone.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                ...
                                Ce code peut être obtenu depuis une application TOTP
                                compatible sur votre téléphone.
                            </p>
