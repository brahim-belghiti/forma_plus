                            ...
                            <>
                                ...
                                <div className="text-xs text-muted-foreground select-none">
                                    <p id="regenerate-warning">
                                        Chaque code de récupération ne peut être utilisé
                                        qu'une seule fois pour accéder à votre compte et
                                        sera supprimé après utilisation. Si vous avez besoin
                                        de plus de codes, cliquez sur{' '}
